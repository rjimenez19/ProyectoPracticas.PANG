...
public class SpriteDisparoPistola {

    private int ancho, alto;
    private int x = 0, y = 0, y2;
    private Bitmap bmp;
    private int currentFrame;
    private int yVelocidad = 30;
    private int incremento;
    private int incremento2;

    public SpriteDisparoPistola(Pantalla pantalla, Bitmap bmp, int x, int y) {
        this.bmp = bmp;
        this.x = x;
        this.y = y;
        this.y2 = y;
    ...
    public void onDraw(Canvas canvas) {
        ...
        Rect src = new Rect(srcX, 1, srcX + ancho, alto);
